use crate::{Asset, ExtendedSymbol, Name};
...
mod tests {
    ...
    fn test_ord() {
        ...
        let c = ExtendedAsset::from_amount(200, ExtendedSymbol::from_extended(Symbol::from("4,SYM"), Name::from("contract2")));
        let d = ExtendedAsset::from_amount(200, ExtendedSymbol::from_extended(Symbol::from("4,SYM"), Name::from("contract")));
